...
namespace Php\MongoDb;

use Hyperf\Task\Annotation\Task;
use MongoDB\BSON\JavascriptInterface;
use MongoDB\Operation\Explainable;
use Php\MongoDb\Exception\MongoDBException;
use Php\MongoDb\Pool\PoolFactory;
use Hyperf\Utils\Context;
use Php\MongoDb\Utils\Arr;
...
class MongoTask
{
     ...
     * @throws MongoDBException
     */
    public function findOne($collectionName, $filter = [], array $options = [], array $collectionOptions = []): array
    {
        try {
            /**
     ...
     * @throws MongoDBException
     */
    public function findAll($collectionName, array $filter = [], array $options = [], array $collectionOptions = [])
    {
        try {
            /**
             * @var $collection MongoDBConnection
